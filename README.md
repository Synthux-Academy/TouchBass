...
## QUICK INSTALL
Download the [Binary file]([https://github.com/Synthux-Academy/TouchBass/raw/main/TouchBass.bin](https://github.com/Synthux-Academy/TouchBass/releases/latest/download/TouchBass.bin)) and flash using the [Daisy Seed web programmer](https://electro-smith.github.io/Programmer/)
